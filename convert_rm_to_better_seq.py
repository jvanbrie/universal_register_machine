...
def main(args):
	...
	for one_command in file_list:
		...
		if(command_list[0] == 'inc'):
			seq_number = seq_cons(int(command_list[1]),seq_cons(int(command_list[2]),seq_cons(0,seq_number)))
		elif(command_list[0] == 'dec'):
			seq_number = seq_cons(int(command_list[1]),seq_cons(int(command_list[2]),seq_cons(int(command_list[3]),seq_cons(0,seq_number))))
		else:
